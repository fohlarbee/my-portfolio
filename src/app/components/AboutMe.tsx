    ...
    <section className="text-[#fff]">
        <div className="md:grid md:grid-cols-2 gap-8 items-center px-8 py-4 ">
            ...
            <div>
                ...
                <p className="text-base lg:text-lg"> Welcome to my digital hub! I&#39m a versatile developer proficient in a diverse range of technologies, including JavaScript, Node.js, and TypeScript. With a keen eye for design, I specialize in crafting captivating user interfaces using HTML and CSS, ensuring a seamless user experience across platforms. Leveraging Git for version control, I maintain clean and organized codebases, fostering collaboration and efficiency in development workflows. My expertise extends to Redux for state management, empowering applications with robust data handling capabilities. As a Firebase expert, I excel in building real-time applications that harness the power of the cloud. Additionally, I utilize Express for backend development and MongoDB for efficient database management. Beyond coding, I&#39m an enthusiastic content creator on YouTube, where I share my insights and experiences in the ever-evolving tech landscape. Let&#39s join forces and transform your ideas into impactful digital solutions!</p>
