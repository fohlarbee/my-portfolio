...
export default function ProjectCard({imagUrl, title, desc} : Params) {
  return (
    <div className="relative group">
        <div className="h-52 md:72" style={{background: `url(${imagUrl})`, backgroundSize:'cover'}}></div>
        <div className=" hidden justify-center items-center overlay absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0  group-hover:bg-opacity-50 group-hover:flex transition-all duration-500">
            <Link href='/' className='relative mr-4 w-14 h-14 rounded-full border-[#ADB7BE] border-4 hover:border-[#fff] group/link'>
            ...
            <Link href='/' className='relative w-14 h-14 rounded-full border-[#ADB7BE] border-4 hover:border-[#fff] group/link'>
        ...
        <div className="rounded-b-xl text=[#f ff] py-4 px-4 bg-[#181818] ">
